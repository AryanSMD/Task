...
onBeforeMount(() => {
    route.path.endsWith('edit') && (editMode.value = true);
})
</script>
...
<template>
    <div class="w-full flex flex-col items-center gap-4 py-10">
        ...
        <div class="card flex items-center justify-end gap-4">
            <button class="del-btn" v-if="editMode">
        ...
        <div class="card">
            <div class="form">
                ...
                <div>
                    ...
                    <select :disabled="editMode" v-model="newForm.form_type">
                        <option 
